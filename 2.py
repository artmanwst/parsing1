...
def get_page(url):
    try:
        ...
        print(f"Ошибка при отправке запроса: {str(except1)}")
        return None

with open('top1000.csv', 'w', newline='', encoding='utf-8') as csv_file:
    csv_writer = csv.writer(csv_file)
    csv_writer.writerow(['Название фильма', 'Год создания', 'Оценка', 'Страна', 'Режиссер', 'Возможность просмотра на кинопоиске'])
    ...
    for i in range(1, 21):
        ...
        or movie_block in movie_blocks:
